...
- Stores passcodes as salted PBKDF2 hashes instead of plaintext.
- Stores each profile's funds in Firebase Firestore.
...
The app opens an anonymous Firebase Auth session before reading or writing Firestore. In the Firebase console, enable **Authentication > Sign-in method > Anonymous**, then publish the included Firestore rules:
